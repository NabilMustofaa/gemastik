...
<body class=" bg-zinc-100">
  ...
  <div id="profileModal" class="absolute opacity-0 top-0 left-0 w-screen h-full bg-black bg-opacity-50 -z-10 transition-all transform">
    <div id="profileModalContent" class="absolute top-[125px] right-[-3%] transform -translate-x-1/2 -translate-y-1/2 w-2/7 h-fit p-2 bg-white rounded-md shadow-md w-52">
